...
export interface RebuildStakeholdersProjectionInput {
...
export interface RebuildStakeholdersProjectionResult {
...
export interface RebuildStakeholdersProjectionServiceDeps {
...
export interface RebuildStakeholdersProjectionService {
  rebuild(
    input: RebuildStakeholdersProjectionInput,
  ): Promise<Result<RebuildStakeholdersProjectionResult, CommandError>>;
}

/**
 * Rebuild Stakeholders from authoritative SimulationState.stakeholders.
 * Does not resolve content definitions, mutate SimulationRun, or emit
 * Stakeholder Domain events.
 */
export const createRebuildStakeholdersProjectionService = (
  deps: RebuildStakeholdersProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildStakeholdersProjection(
