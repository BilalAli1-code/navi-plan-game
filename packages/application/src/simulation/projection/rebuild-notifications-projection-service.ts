...
export interface RebuildNotificationsProjectionInput {
...
export interface RebuildNotificationsProjectionResult {
...
export interface RebuildNotificationsProjectionServiceDeps {
...
export interface RebuildNotificationsProjectionService {
  rebuild(
    input: RebuildNotificationsProjectionInput,
  ): Promise<Result<RebuildNotificationsProjectionResult, CommandError>>;
}

/**
 * Rebuild Notifications from authoritative SimulationState.notifications.
 * Does not mutate SimulationRun or emit Notification Domain events.
 */
export const createRebuildNotificationsProjectionService = (
  deps: RebuildNotificationsProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildNotificationsProjection(
