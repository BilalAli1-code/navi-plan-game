...
export interface RebuildMeetingsProjectionInput {
...
export interface RebuildMeetingsProjectionResult {
...
export interface RebuildMeetingsProjectionServiceDeps {
...
export interface RebuildMeetingsProjectionService {
  rebuild(
    input: RebuildMeetingsProjectionInput,
  ): Promise<Result<RebuildMeetingsProjectionResult, CommandError>>;
}

/**
 * Rebuild Meetings from authoritative SimulationState.meetings.
 * Does not resolve content definitions, mutate SimulationRun, or emit
 * Meeting Domain events.
 */
export const createRebuildMeetingsProjectionService = (
  deps: RebuildMeetingsProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildMeetingsProjection(
