...
export interface RebuildActivitiesProjectionInput {
...
export interface RebuildActivitiesProjectionResult {
...
export interface RebuildActivitiesProjectionServiceDeps {
...
export interface RebuildActivitiesProjectionService {
  rebuild(
    input: RebuildActivitiesProjectionInput,
  ): Promise<Result<RebuildActivitiesProjectionResult, CommandError>>;
}

/**
 * Rebuild Activities from authoritative SimulationState.activities (status=active).
 * Does not mutate SimulationRun or emit Activity Domain events.
 */
export const createRebuildActivitiesProjectionService = (
  deps: RebuildActivitiesProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildActivitiesProjection(
