...
export interface RebuildAchievementsProjectionInput {
...
export interface RebuildAchievementsProjectionResult {
...
export interface RebuildAchievementsProjectionServiceDeps {
...
export interface RebuildAchievementsProjectionService {
  rebuild(
    input: RebuildAchievementsProjectionInput,
  ): Promise<Result<RebuildAchievementsProjectionResult, CommandError>>;
}

/**
 * Rebuild Achievements from authoritative SimulationRun snapshot evidence.
 */
export const createRebuildAchievementsProjectionService = (
  deps: RebuildAchievementsProjectionServiceDeps,
