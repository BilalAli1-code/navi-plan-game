...
export interface RebuildCoachingProjectionInput {
...
export interface RebuildCoachingProjectionResult {
...
export interface RebuildCoachingProjectionServiceDeps {
...
export interface RebuildCoachingProjectionService {
  rebuild(
    input: RebuildCoachingProjectionInput,
  ): Promise<Result<RebuildCoachingProjectionResult, CommandError>>;
}

/**
 * Rebuild Coaching from authoritative SimulationRun snapshot evidence.
 */
export const createRebuildCoachingProjectionService = (
  deps: RebuildCoachingProjectionServiceDeps,
