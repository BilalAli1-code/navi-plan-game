...
export interface RebuildDecisionLogProjectionInput {
...
export interface RebuildDecisionLogProjectionResult {
...
export interface RebuildDecisionLogProjectionServiceDeps {
...
export interface RebuildDecisionLogProjectionService {
  rebuild(
    input: RebuildDecisionLogProjectionInput,
  ): Promise<Result<RebuildDecisionLogProjectionResult, CommandError>>;
}

export const createRebuildDecisionLogProjectionService = (
  deps: RebuildDecisionLogProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildDecisionLogProjection(
