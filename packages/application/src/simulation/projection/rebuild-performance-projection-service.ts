...
export interface RebuildPerformanceProjectionInput {
...
export interface RebuildPerformanceProjectionResult {
...
export interface RebuildPerformanceProjectionServiceDeps {
...
export interface RebuildPerformanceProjectionService {
  rebuild(
    input: RebuildPerformanceProjectionInput,
  ): Promise<Result<RebuildPerformanceProjectionResult, CommandError>>;
}

/**
 * Rebuild Performance from authoritative SimulationRun snapshot evidence.
 */
export const createRebuildPerformanceProjectionService = (
  deps: RebuildPerformanceProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildPerformanceProjection(
