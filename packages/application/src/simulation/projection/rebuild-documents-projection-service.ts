...
export interface RebuildDocumentsProjectionInput {
...
export interface RebuildDocumentsProjectionResult {
...
export interface RebuildDocumentsProjectionServiceDeps {
...
export interface RebuildDocumentsProjectionService {
  rebuild(
    input: RebuildDocumentsProjectionInput,
  ): Promise<Result<RebuildDocumentsProjectionResult, CommandError>>;
}

/**
 * Rebuild Documents from authoritative SimulationState.documents.
 * Does not mutate SimulationRun or emit Document Domain events.
 */
export const createRebuildDocumentsProjectionService = (
  deps: RebuildDocumentsProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildDocumentsProjection(
