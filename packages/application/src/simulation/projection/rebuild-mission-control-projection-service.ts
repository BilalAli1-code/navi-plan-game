...
export interface RebuildMissionControlProjectionInput {
...
export interface RebuildMissionControlProjectionResult {
...
export interface RebuildMissionControlProjectionServiceDeps {
...
export interface RebuildMissionControlProjectionService {
  rebuild(
    input: RebuildMissionControlProjectionInput,
  ): Promise<Result<RebuildMissionControlProjectionResult, CommandError>>;
}

export const createRebuildMissionControlProjectionService = (
  deps: RebuildMissionControlProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildMissionControlProjection(
