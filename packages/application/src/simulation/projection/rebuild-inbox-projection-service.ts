...
export interface RebuildInboxProjectionInput {
...
export interface RebuildInboxProjectionResult {
...
export interface RebuildInboxProjectionServiceDeps {
...
export interface RebuildInboxProjectionService {
  rebuild(
    input: RebuildInboxProjectionInput,
  ): Promise<Result<RebuildInboxProjectionResult, CommandError>>;
}

/**
 * Rebuild Inbox from authoritative SimulationState.learnerMessages.
 * Does not resolve content definitions, mutate SimulationRun, or emit
 * LearnerMessageDelivered.
 */
export const createRebuildInboxProjectionService = (
  deps: RebuildInboxProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildInboxProjection(
