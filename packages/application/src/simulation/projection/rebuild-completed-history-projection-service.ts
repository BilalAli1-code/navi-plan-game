...
export interface RebuildCompletedHistoryProjectionInput {
...
export interface RebuildCompletedHistoryProjectionResult {
...
export interface RebuildCompletedHistoryProjectionServiceDeps {
...
export interface RebuildCompletedHistoryProjectionService {
  rebuild(
    input: RebuildCompletedHistoryProjectionInput,
  ): Promise<Result<RebuildCompletedHistoryProjectionResult, CommandError>>;
}

/**
 * Rebuild Completed History from authoritative SimulationState.activities
 * (status=completed, ordered by completionSequence descending).
 * Does not mutate SimulationRun or emit Activity Domain events.
 */
export const createRebuildCompletedHistoryProjectionService = (
  deps: RebuildCompletedHistoryProjectionServiceDeps,
  ...
  async rebuild(input) {
    ...
    const built = buildCompletedHistoryProjection(
